...
/**
 * An {@code HttpMessageConverter} that reads and writes {@link Message}s
 ...
 * @since 4.1
 */
public class MyProtobufHttpMessageConverter extends AbstractHttpMessageConverter<Message> {
    ...
    private static final ProtobufFormatter JSON_FORMAT = new MyJsonFormat();
     ...
     */
    public MyProtobufHttpMessageConverter() {
        this(null);
    }
     ...
     */
    public MyProtobufHttpMessageConverter(ExtensionRegistryInitializer registryInitializer) {
    ...
    protected Message readInternal(Class<? extends Message> clazz, HttpInputMessage inputMessage)
        ...
        try {
            ...
            if (MediaType.TEXT_PLAIN.isCompatibleWith(contentType)) {
                ...
                JSON_FORMAT.merge(inputMessage.getBody(), charset, extensionRegistry, builder);
